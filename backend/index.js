...
app.get("/", async (req, res) => {
  try {
    ...
    console.log("Conexión con la base de datos establecida correctamente:", result);
...
app.get("/tables", async (req, res) => {
  try {
    const result = await connection.any('SELECT table_name FROM information_schema.tables WHERE table_schema = \'public\';');
